...
# <ol>
#   <li>딕셔너리 변수 "K3_dict"</li>
#   <li>요청 함수 저장 변수 "real_event"</li>
# </ol>
# "K3_dict" 딕셔너리는 알고리즘 추천종목의 체결 정보를 저장 할 변수이고, "real_event" 는 체결정보 요청 함수를 저장 할 변수 입니다.
...
# MyObjects 클래스에서 추가된 변수는 2개 입니다.
# <ol>
#   <li>딕셔너리 변수 "HA_dict"</li>
#   <li>요청 함수 저장 변수 "real_event_event"</li>
# </ol>
# "HA_dict" 딕셔너리는 알고리즘 추천종목의 호가 및 호가잔량 정보를 저장 할 변수이고, "real_event_ha" 는 호가 요청 함수를 저장 할 변수 입니다.
